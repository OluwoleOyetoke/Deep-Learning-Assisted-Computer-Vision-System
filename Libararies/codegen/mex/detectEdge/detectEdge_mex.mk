...
MAKEFILE = detectEdge_mex.mk

include detectEdge_mex.mki
...
SRC_FILES =  \
	...
	_coder_detectEdge_mex.cpp \
	detectEdge_emxutil.cpp

MEX_FILE_NAME_WO_EXT = detectEdge_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\detectEdge"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\detectEdge/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\detectEdge/%.cpp
	$(CC) $(CPPFLAGS) "$<"
