...
MAKEFILE = sumTest_mex.mk

include sumTest_mex.mki
...
MEX_FILE_NAME_WO_EXT = sumTest_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\sumTest"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\sumTest/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\sumTest/%.cpp
	$(CC) $(CPPFLAGS) "$<"
