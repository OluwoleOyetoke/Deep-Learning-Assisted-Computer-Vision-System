/*
 * detectEdge_emxutil.h
 *
 * Code generation for function 'detectEdge_emxutil'
 *
 */

#ifndef DETECTEDGE_EMXUTIL_H
#define DETECTEDGE_EMXUTIL_H
...
/* End of code generation (detectEdge_emxutil.h) */
