/*
 * shapeAnalyser_emxutil.h
 *
 * Code generation for function 'shapeAnalyser_emxutil'
 *
 */

#ifndef SHAPEANALYSER_EMXUTIL_H
#define SHAPEANALYSER_EMXUTIL_H
...
/* End of code generation (shapeAnalyser_emxutil.h) */
