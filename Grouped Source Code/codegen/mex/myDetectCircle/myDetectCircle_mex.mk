...
MAKEFILE = myDetectCircle_mex.mk

include myDetectCircle_mex.mki


SRC_FILES =  \
	myDetectCircle_data.c \
...
MEX_FILE_NAME_WO_EXT = myDetectCircle_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\myDetectCircle"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\myDetectCircle/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\myDetectCircle/%.cpp
	$(CC) $(CPPFLAGS) "$<"
