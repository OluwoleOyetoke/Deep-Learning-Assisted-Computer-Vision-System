...
static emlrtRSInfo d_emlrtRSI = { 28, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo e_emlrtRSI = { 29, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo f_emlrtRSI = { 45, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo g_emlrtRSI = { 46, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo h_emlrtRSI = { 47, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo i_emlrtRSI = { 50, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo j_emlrtRSI = { 55, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo k_emlrtRSI = { 62, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRSInfo l_emlrtRSI = { 68, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo c_emlrtRTEI = { 1, 18, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo d_emlrtRTEI = { 186, 13, "find",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"
};

static emlrtRTEInfo e_emlrtRTEI = { 187, 13, "find",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"
};

static emlrtRTEInfo f_emlrtRTEI = { 28, 1, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo g_emlrtRTEI = { 29, 1, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo h_emlrtRTEI = { 45, 5, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo i_emlrtRTEI = { 46, 5, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo j_emlrtRTEI = { 50, 5, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo k_emlrtRTEI = { 55, 1, "detectCorner",
  "C:\\Users\\Oluwole_Jnr\\Desktop\\University of Leeds\\Main Project\\Project_MATLab\\MatConvNet - Optimized\\detectCorner.m"
};

static emlrtRTEInfo l_emlrtRTEI = { 50, 15, "find",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"
};

static emlrtRTEInfo t_emlrtRTEI = { 172, 9, "find",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"
};

static emlrtRTEInfo u_emlrtRTEI = { 126, 19, "find",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"
};
                  ...
                  emxArray_real_T *r, emxArray_real_T *c)
{
  ...
  emxInit_real_T1(sp, &Ix, 2, &f_emlrtRTEI, true);
  emxInit_real_T1(sp, &Iy, 2, &g_emlrtRTEI, true);
  emxInit_real_T1(sp, &r0, 2, &c_emlrtRTEI, true);
      ...
      while (firstColA <= lastColA) {
        ...
        for (i = firstRowB; i <= lastRowB; i++) {
          ...
          if (ma > 128) {
            ...
            xaxpy(a_length, iv0[iB], img, (b_c + ii) + 1, Iy, iC + 1);
          } else {
            ii += b_c;
            jj = iC;
  ...
  emxInit_real_T1(sp, &c_Ix, 2, &c_emlrtRTEI, true);
  if ((b_Ix[0] != b_Iy[0]) || (b_Ix[1] != b_Iy[1])) {
    emlrtSizeEqCheckNDR2012b(&b_Ix[0], &b_Iy[0], &g_emlrtECI, sp);
  }
  ...
  emxInit_real_T1(sp, &Ix2, 2, &h_emlrtRTEI, true);
  emxInit_real_T1(sp, &c_Iy, 2, &c_emlrtRTEI, true);
  st.site = &f_emlrtRSI;
  b_conv2(&st, c_Ix, Ix2);
  ...
  emxInit_real_T1(sp, &Iy2, 2, &i_emlrtRTEI, true);
  emxInit_real_T1(sp, &d_Ix, 2, &c_emlrtRTEI, true);
  st.site = &g_emlrtRSI;
  b_conv2(&st, c_Iy, Iy2);
  ...
  emxInit_real_T1(sp, &r1, 2, &c_emlrtRTEI, true);
  st.site = &h_emlrtRSI;
  b_conv2(&st, d_Ix, r1);
  ii = Ix->size[0] * Ix->size[1];
  Ix->size[0] = r1->size[0];
  ...
  emxInit_real_T1(sp, &det, 2, &j_emlrtRTEI, true);
  if ((b_Ix2[0] != b_Iy2[0]) || (b_Ix2[1] != b_Iy2[1])) {
    emlrtSizeEqCheckNDR2012b(&b_Ix2[0], &b_Iy2[0], &f_emlrtECI, sp);
  }
  ...
  emxInit_real_T1(sp, &r2, 2, &c_emlrtRTEI, true);
  st.site = &i_emlrtRSI;
  power(&st, Ix, r2);
  ii = Iy->size[0] * Iy->size[1];
  Iy->size[0] = r2->size[0];
  ...
  if ((b_det[0] != d_Iy[0]) || (b_det[1] != d_Iy[1])) {
    emlrtSizeEqCheckNDR2012b(&b_det[0], &d_Iy[0], &e_emlrtECI, sp);
  }
  ...
  emxInit_real_T1(sp, &d_Ix2, 2, &c_emlrtRTEI, true);
  if ((c_Ix2[0] != c_Iy2[0]) || (c_Ix2[1] != c_Iy2[1])) {
    emlrtSizeEqCheckNDR2012b(&c_Ix2[0], &c_Iy2[0], &d_emlrtECI, sp);
  }
  ...
  emxFree_real_T(&Iy2);
  emxFree_real_T(&Ix2);
  emxInit_real_T1(sp, &r3, 2, &c_emlrtRTEI, true);
  st.site = &j_emlrtRSI;
  power(&st, d_Ix2, r3);
  ii = Ix->size[0] * Ix->size[1];
  Ix->size[0] = r3->size[0];
  ...
  if ((c_det[0] != e_Ix[0]) || (c_det[1] != e_Ix[1])) {
    emlrtSizeEqCheckNDR2012b(&c_det[0], &e_Ix[0], &c_emlrtECI, sp);
  }
  ...
  emxInit_boolean_T(sp, &R, 2, &k_emlrtRTEI, true);
  if ((d_det[0] != f_Ix[0]) || (d_det[1] != f_Ix[1])) {
    emlrtSizeEqCheckNDR2012b(&d_det[0], &f_Ix[0], &b_emlrtECI, sp);
  }
  ...
  emxInit_boolean_T(sp, &r4, 2, &c_emlrtRTEI, true);
  ...
  if ((b_R[0] != iv1[0]) || (b_R[1] != iv1[1])) {
    emlrtSizeEqCheckNDR2012b(&b_R[0], &iv1[0], &emlrtECI, sp);
  }
  ...
  emxInit_int32_T(&b_st, &b_ii, 1, &c_emlrtRTEI, true);
  emxInit_int32_T(&b_st, &b_jj, 1, &c_emlrtRTEI, true);
  emxInit_boolean_T1(&b_st, &v, 1, &l_emlrtRTEI, true);
  ii = b_ii->size[0];
  b_ii->size[0] = nx;
...
/* End of code generation (detectCorner.c) */
