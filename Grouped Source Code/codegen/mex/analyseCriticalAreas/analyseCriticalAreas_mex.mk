...
MAKEFILE = analyseCriticalAreas_mex.mk

include analyseCriticalAreas_mex.mki
...
MEX_FILE_NAME_WO_EXT = analyseCriticalAreas_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\analyseCriticalAreas"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\analyseCriticalAreas/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\analyseCriticalAreas/%.cpp
	$(CC) $(CPPFLAGS) "$<"
