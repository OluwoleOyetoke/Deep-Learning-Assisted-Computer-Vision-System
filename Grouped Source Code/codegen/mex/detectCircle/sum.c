...
static emlrtRTEInfo le_emlrtRTEI = { 20, 15, "sumprod",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m"
};

static emlrtRTEInfo me_emlrtRTEI = { 48, 9, "sumprod",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m"
};
...
real_T sum(const emlrtStack *sp, const emxArray_real_T *x)
{
  ...
  if (overflow) {
    ...
    emlrtErrorWithMessageIdR2012b(&st, &le_emlrtRTEI,
  ...
  if (!overflow) {
    ...
    emlrtErrorWithMessageIdR2012b(&st, &me_emlrtRTEI,
